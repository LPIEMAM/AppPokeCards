...
class CarouselConfigInfo {
     ...
     */
    static final int MAX_QUANTITY = 14;
     ...
     */
    static final float MIN_SCALE = 0f;
    
    /**
     * Max velocity for scrolling.
     */
    static final int MAX_SCROLLING_VELOCITY = 160;
     ...
     */
    static final float CAROUSEL_ITEM_Y_POSITION= 0f;
}
